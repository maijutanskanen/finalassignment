...
In this final assignment, logistic regression analysis is used to study predictors of domestic violence victimization in the Public Safety Survey 2009 data. 

Gender, age in years, education level, non-domestic violent victimization and crime problem in respondent’s neighbourhood are used as independent variables in the analysis, and following hypotheses are made:
